<div id="mason-preview-container">
    ...
    @else
        ...
        @foreach($blocks as $block)
            ...
            <div class="mason-drop-zone" data-drop-index="{{ $block['index'] + 1 }}"></div>
        @endforeach
    @endif
</div>
...
<script>
    ...
    (function() {
        ...
        container.addEventListener('dragstart', function(e) {
            ...
            if (!block.hasAttribute('draggable') || block.getAttribute('draggable') !== 'true') {
                return;
            }
        ...
        container.addEventListener('dragover', function(e) {
            ...
            if (draggedBlockIndex !== null) {
                ...
                if (dropZone) {
                    dropZone.classList.add('active');
                    dragOverIndex = parseInt(dropZone.getAttribute('data-drop-index'));
                }
            }
        });
